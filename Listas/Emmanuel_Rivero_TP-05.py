...
# y mostrar el penúltimo. ¡Puedes hacerlo como se muestra en los videos o bien investigar cómo funciona el indexing con números negativos!
lista_2 = ["Hendrix", "SRV", "Santana", 1000, 300, ["Black Sabbath", "Led Zeppelin"], True]
penultimo_lista_2 = lista_2[-2]
print(penultimo_lista_2)
...
lista_3 = []
lista_3.append("River Plate")
lista_3.append("Boca Juniors")
lista_3.append("Independiente")
print(lista_3)
...
print(numeros)
# El programa lo que hace es crear una lista de números, luego remover el número mayor, y luego imprime la lista números (sin el número mayor (22))
